...
{
    public class ModuleSlotView : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
    {
            ...
            if (item != null)
            {
                if (item.item != null)
                {
                    if (eventData.button == PointerEventData.InputButton.Right)
                    {
                        ...
                        new ItemEvents().ItemRightClickEvent(item, this.transform.position, "moduleView");
                    }
